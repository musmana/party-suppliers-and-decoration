...
import suppliersBg from "/suppliers-bg.png"; 
...
import TrendingChoreographers from "../components/TrendingChoreographers";
import dream3 from "/dream3.png";
  ...
  const [categoryOpen, setCategoryOpen] = useState(false);
   ...
   return (
     ...
     <section
       ...
       style={{ backgroundImage: `url(${suppliersBg})` }}
     >
       {/* Overlay */}
      ...
      <div className="flex flex-col md:flex-row items-center border border-gray-300 bg-gray-50 p-6 md:p-8 rounded-md shadow-sm">
        ...
        <div className="md:w-2/2 w-full md:pl-10 mt-6 md:mt-0 flex flex-col justify-between text-center md:text-left">
          ...
          <div className="mt-8 md:mt-10">
            <button className="bg-gray-400 hover:bg-gray-600 text-white px-8 py-3 float-right font-semibold transition-all duration-300">
              View
            </button>
          </div>
        </div>
